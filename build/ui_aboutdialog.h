...
"Copyright &copy; 2011-YYYY The Poins developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Poins", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Poins</b> version", 0));
